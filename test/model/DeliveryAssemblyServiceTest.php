...
class DeliveryAssemblyServiceTest extends TaoPhpUnitTestRunner
{
    ...
    private function getAssembly(){
        ...
        $assemblyServiceMock = $this->getMockBuilder('oat\taoDeliveryTemplate\model\TemplateAssemblyService')
        ->setMethods(array(
            'getCompiler'
        ))
        ->setMockClassName('TemplateAssemblyService_Mock')
        ->disableOriginalConstructor()
        ->getMock();
        ...
        $report = $assemblyServiceMock->createAssemblyByContent($rootClass, $this->content);
        return $report;
    }
