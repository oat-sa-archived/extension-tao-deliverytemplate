...
define(['module' ,'jquery', 'i18n', 'context', 'helpers'], function(module, $, __, context, helpers){
    ...
    function initCompilation(uri, clazz){
        ...
        $.ajax({
	        url: helpers._url('compile', 'Compilation', 'taoDeliveryTemplate'),
	        type: "POST",
	        dataType: "text",
    ...
    return {
        start : function(){
            ...
            $('.back').click(function(e){
                e.preventDefault();
                helpers._load(helpers.getMainContainerSelector(), helpers._url('editTemplate', 'DeliveryTemplate', 'taoDeliveryTemplate'), {
                    uri: conf.uri,
